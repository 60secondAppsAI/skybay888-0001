...
<template>
  ...
  <base-input label="FirstName" type="text" placeholder="Enter FirstName" v-model="crewToAdd.firstName"></base-input>
  <base-input label="LastName" type="text" placeholder="Enter LastName" v-model="crewToAdd.lastName"></base-input>
