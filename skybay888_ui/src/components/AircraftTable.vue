...
<template>
  ...
  <base-input label="Model" type="text" placeholder="Enter Model" v-model="aircraftToAdd.model"></base-input>
  <base-input label="Capacity" type="text" placeholder="Enter Capacity" v-model="aircraftToAdd.capacity"></base-input>
                  </form>
                </div>
