					...
					<tr> 
						<td style="width: 100%;"></td>
				        	<td style="width: 150px;">
				      			<base-button class="btn btn-primary" @click="updateTicket()">Save</base-button>
				        	</td>
				        	<td style="width: 150px;">
				        	<td style="width: 150px;">
								...
								<div >
								  <div class="container">
												    <base-button class="btn btn-primary" @click="modal2Tickets = true">Add</base-button>
								              <modal :show.sync="modal2Tickets">
								  ...
								  <base-input label="BookingDate" type="text" placeholder="Enter BookingDate" v-model="ticketToAdd.bookingDate"></base-input>
												                  </form>
								                </div>
          ...
          <a-modal :footer="null" :visible="userPermissionDialog" :closable="false" class="centered-modal" v-if="userPermissionDialog">
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
										...
										<tr> 
					<td class="detail_view_column_2">Ticket Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="TicketId" type="text" placeholder="Enter TicketId" v-model="ticketDetails.ticketId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Seat Number</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="SeatNumber" type="text" placeholder="Enter SeatNumber" v-model="ticketDetails.seatNumber"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Booking Date</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<datepicker v-model="ticketDetails.bookingDate"  placeholder="Select Date" ></datepicker>
																		</div>
						</td>
														</tr>
...
export default {
  ...
  methods: {
    ...
    async updateTicket() {
      ...
      const jsonData = JSON.stringify(this.ticketDetails);
      const res = await TicketService.update(jsonData);
...
//        this.getAllTickets();
    ...
    async getTicketDetails() {
      try {
			let response = await TicketService.get(this.ticketId);
