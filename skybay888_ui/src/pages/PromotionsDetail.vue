					...
					<tr> 
						<td style="width: 100%;"></td>
				        	<td style="width: 150px;">
				      			<base-button class="btn btn-primary" @click="updatePromotions()">Save</base-button>
				        	</td>
				        	<td style="width: 150px;">
				        	<td style="width: 150px;">
								...
								<div >
								  <div class="container">
												    <base-button class="btn btn-primary" @click="modal2Promotionss = true">Add</base-button>
								              <modal :show.sync="modal2Promotionss">
          ...
          <a-modal :footer="null" :visible="userPermissionDialog" :closable="false" class="centered-modal" v-if="userPermissionDialog">
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
										...
										<tr> 
					<td class="detail_view_column_2">Promotions Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="PromotionsId" type="text" placeholder="Enter PromotionsId" v-model="promotionsDetails.promotionsId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Promotion Name</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="PromotionName" type="text" placeholder="Enter PromotionName" v-model="promotionsDetails.promotionName"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Description</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Description" type="text" placeholder="Enter Description" v-model="promotionsDetails.description"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Validity</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<datepicker v-model="promotionsDetails.validity"  placeholder="Select Date" ></datepicker>
																		</div>
						</td>
														</tr>
...
export default {
  ...
  methods: {
    ...
    async updatePromotions() {
      ...
      const jsonData = JSON.stringify(this.promotionsDetails);
      const res = await PromotionsService.update(jsonData);
...
//        this.getAllPromotionss();
    ...
    async getPromotionsDetails() {
      try {
			let response = await PromotionsService.get(this.promotionsId);
			this.promotionsDetails = response.data;
