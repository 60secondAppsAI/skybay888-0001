...
-->>
				...
				<a-menu-item>
					<router-link to="/flightStatuss">
						<span class="label">Flight Statuss</span>
					</router-link>
				</a-menu-item>
		
				<a-menu-item>
					<router-link to="/loungess">
						<span class="label">Loungess</span>
					</router-link>
				</a-menu-item>
		
				<a-menu-item>
					<router-link to="/delayss">
						<span class="label">Delayss</span>
					</router-link>
				</a-menu-item>
		
				<a-menu-item>
					<router-link to="/ticketPrices">
						<span class="label">Ticket Prices</span>
					</router-link>
				</a-menu-item>
		
				<a-menu-item>
					<router-link to="/customerServiceRequests">
						<span class="label">Customer Service Requests</span>
					</router-link>
				</a-menu-item>
		
				<a-menu-item>
					<router-link to="/promotionss">
						<span class="label">Promotionss</span>
					</router-link>
				</a-menu-item>
